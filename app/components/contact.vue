<template>
    ...
    class="relative bg-[#F4F5F9] w-full h-[1600px] xl:h-[800px] 2xl:h-screen flex flex-col justify-center items-center py-20">
        ...
        <div class="flex flex-col justify-center items-center mb-40 sm:mb-20 2xl:mb-0">
          ...
          <h5 class="flex xl:hidden text-center font-GenJyuuGothicBold tracking-[1px] sm:tracking-[1px] text-[21px] xl:text-[24px] contact-text-gradient-4-colors mb-4">期待您的加入，<br>與我們一同創造無限可能。</h5>
                ...
                <ul class="flex flex-row gap-8 justify-center items-center">
                    <li>
                      <a href="/" target="_blank" rel="noopener noreferrer">
                        <img src="/gaobang.webp" alt="logo" class="w-[35px]" loading="lazy" />
                      </a>
                    </li>
                    <li>
